...
var encoder = JSON.parse(
  fs.readFileSync(path.join(__dirname, './_encoder.json'), 'utf-8'),
);
var bpe_file = fs.readFileSync(path.join(__dirname, './_vocab.bpe'), 'utf-8');
var range = (x, y) => {
